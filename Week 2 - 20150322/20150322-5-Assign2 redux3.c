...
int main (void)
{
    ...
    commissionCents = (salesAmtCents * (12.5 / 100)) + 0.5;
    bonusCents = ((years * (weeksProfitCents * (0.5 / 100))) + 5000) +0.5;
    grossSalCents = commissionCents + bonusCents;
    retirementCents = (grossSalCents * (8.0 / 100)) + 0.5;
    stateTaxCents = (grossSalCents * (10.0 / 100)) + 0.5;
    fedTaxCents = (grossSalCents * (25.0 / 100)) + 0.5;
